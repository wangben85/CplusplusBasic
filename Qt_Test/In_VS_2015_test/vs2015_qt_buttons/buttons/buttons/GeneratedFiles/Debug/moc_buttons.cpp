...
QT_MOC_LITERAL(1, 8, 24), // "slotCheckBoxStateChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 5), // "state"
QT_MOC_LITERAL(4, 40, 22), // "slotRadioButtonClicked"
QT_MOC_LITERAL(5, 63, 24) // "slotRadioButton_2Clicked"

    },
    "buttons\0slotCheckBoxStateChanged\0\0"
    "state\0slotRadioButtonClicked\0"
    "slotRadioButton_2Clicked"
};
...
void buttons::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotCheckBoxStateChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->slotRadioButtonClicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 2: _t->slotRadioButton_2Clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    }
}
