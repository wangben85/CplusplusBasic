...
public:
    ...
    void setupUi(QWidget *vs2015_qt_signalslotClass)
    {
        ...
        pushButtonTextChange->setGeometry(QRect(44, 220, 121, 23));
        ...
        labelTextClearShow->setGeometry(QRect(210, 280, 101, 41));
    ...
    void retranslateUi(QWidget *vs2015_qt_signalslotClass)
    {
        ...
        pushButtonTextChange->setText(QApplication::translate("vs2015_qt_signalslotClass", "PushToChange", nullptr));
        pushButtonTextClearShow->setText(QApplication::translate("vs2015_qt_signalslotClass", "PushToClearShow", nullptr));
